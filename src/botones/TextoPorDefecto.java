 ...
 * class construction.
 */
public class TextoPorDefecto extends JLabel implements FocusListener, DocumentListener {
	/**
	 * 
	 */
	...
	public TextoPorDefecto(String text, JTextComponent component) {
		this(text, component, Show.ALWAYS);
	}

	public TextoPorDefecto(String text, JTextComponent component, Show show) {
